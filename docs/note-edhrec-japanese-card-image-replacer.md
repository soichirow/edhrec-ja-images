...
1. Tampermonkey（タンパーモンキー）を入れる: https://www.tampermonkey.net/
2. Greasy Fork（グリーシーフォーク）のスクリプトページを開く: https://greasyfork.org/ja/scripts/580860-edhrec-japanese-card-image-replacer
...
Scryfall（スクライフォール）TaggerやScryfallの検索結果ページでも、同じように日本語画像表示、コピー、ショップ検索が使えます。
